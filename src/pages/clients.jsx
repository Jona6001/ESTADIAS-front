...
const Clients = () => {
  ...
  const fetchClientes = async () => {
    setLoading(true);
    try {
      const res = await fetchWithAuth(`${API_BASE}/clientes`, navigate);
  ...
  const handleAdd = async (e) => {
    ...
    setErrorMsg("");
    try {
      const res = await fetchWithAuth(`${API_BASE}/crearCliente`, navigate, {
        method: "POST",
        headers: {
  ...
  const handleDeactivate = async (id) => {
    try {
      const res = await fetchWithAuth(
        `${API_BASE}/clientes/${id}/desactivar`,
        navigate,
        {
          method: "PATCH",
          headers: {
  ...
  const handleReactivate = async (id) => {
    try {
      const res = await fetchWithAuth(
        `${API_BASE}/clientes/${id}/reactivar`,
        navigate,
        {
          method: "PATCH",
          headers: {
